        ...
        <div className="story">
          ...
          <div className="story__text">
            ...
            <p>
              ...
              used. Well, JSX and CSS saves only activate browser refreshes when
              JS is allowed in browser. Not sure what I did differently within a
              span of two hours, but now, when JS is blocked on browser, changes
              do not show and browser doesn't refresh (have to stop and npm
              start to see changes). At least with JS allowed in browser, saves
              auto refresh and are applied to browser. With JS blocked, initial
              CSS and JSX are still applied. Good enough for development...for
              now.
            </p>
            <p className="update">
